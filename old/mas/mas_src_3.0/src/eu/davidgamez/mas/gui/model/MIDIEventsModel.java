...
public class MIDIEventsModel extends AbstractTableModel {
	...
	public String getColumnName(int columnIndex){
		switch(columnIndex){
			case 0: return "Time(ms)";
			case 1: return "Time(ticks)";
			case 2: return "Command";
			case 3: return "Data 1";
			case 4: return "Data 2";
	...
	public Object getValueAt(int row, int col) {
		switch(col){
			case 0: return new Long(midiEventList.get(row).getTimeStamp());
			case 1: return new Long( Math.round( (midiEventList.get(row).getTimeStamp()*1000000) / Globals.getNanoSecPerTick() ) );
			case 2: return new Integer(midiEventList.get(row).getCommand());
			case 3: return new Integer(midiEventList.get(row).getData1());
			case 4: return new Integer(midiEventList.get(row).getData2());
			case 5: return new Integer(midiEventList.get(row).getChannel());
