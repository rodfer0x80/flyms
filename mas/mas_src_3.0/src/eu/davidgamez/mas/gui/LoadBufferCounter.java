...
public class LoadBufferCounter extends JTextField implements BufferListener, ResetListener, TransportListener{
	
	/** Constructor */
	public LoadBufferCounter() {
		super();
        ...
        //Tool tip
        this.setToolTipText("Load buffer counter. The number of the buffer currently being filled with notes by agents.");
